...
public class serveur {
	...
	private static void Address() {
		...
		String badIP = "Veuillez entrer des nombres entre 0 et 255 s�par� par un .\n Par exemple, 152.0.54.254";
		String badPort = "Veuillez entrer uniquement un nombre entre 5000 et 5050 pour le port";
		
		System.out.println("Veuiller entrer votre addresse IP, compos� de quatre entier entre 0 et 255,\n suivi du port, entre 5000 et 5050");
		
		do {
			
			hasValidAddress = true;
					String ligne = keyboard.nextLine();
			//S�parer les octets par "." et le port par ":"
